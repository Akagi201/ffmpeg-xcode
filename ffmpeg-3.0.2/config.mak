...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION= --enable-debug
prefix=/usr/local
...
CFLAGS=   -std=c99 -fomit-frame-pointer -fPIC -pthread -D_GNU_SOURCE=1 -D_THREAD_SAFE -I/usr/local/include/SDL -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -O3 -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
...
CFLAGS-ffplay=-D_GNU_SOURCE=1 -D_THREAD_SAFE -I/usr/local/include/SDL
ZLIB=-lz
LIB_INSTALL_EXTRA_CMD=$$(RANLIB) "$(LIBDIR)/$(LIBNAME)"
EXTRALIBS=-framework QTKit -framework Foundation -framework QuartzCore -framework CoreVideo -framework Foundation -framework AVFoundation -framework CoreMedia -framework CoreFoundation -framework VideoToolbox -framework CoreMedia -framework QuartzCore -framework CoreVideo -framework CoreFoundation -framework VideoDecodeAcceleration -framework QuartzCore -liconv -Wl,-framework,CoreFoundation -Wl,-framework,Security -L/usr/local/lib -lSDLmain -lSDL -Wl,-framework,Cocoa -framework CoreGraphics -lm -llzma -lbz2 -lz -pthread -framework CoreServices 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
...
LIBS-ffplay=-L/usr/local/lib -lSDLmain -lSDL -Wl,-framework,Cocoa
LIBS-ffprobe=
LIBS-ffserver=
LIBS-ffmpeg=
!ARCH_AARCH64=yes
